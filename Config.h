...
#define PINMAP                        MaxPCB2 //    OFF, Choose from: MksGenL2, MiniPCB2, MaxPCB2, MaxESP3, CNC3, STM32Blue,     <-Req'd
...
#define SLEW_RATE_BASE_DESIRED        1.8 //    1.0, n. Desired slew rate in deg/sec. Adjustable at run-time from            <-Req'd
...
#define AXIS2_DRIVER_IGOTO            10000 //    OFF, n, (mA.) Current during slews. OFF uses same as IRUN.                    Option
