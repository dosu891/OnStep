...
#define TELESCOPE_TEMPERATURE      DS1820 //    OFF, DS1820, n. Where n is the DS1820 s/n for focuser temperature.            Adjust
...
#define AXIS1_STEPS_PER_DEGREE    58990 // 57061.1 // guide:58960 //  orig:12800, n. Number of steps per degree:                                          <-Req'd
                                          //         n = (stepper_steps * micro_steps * overall_gear_reduction)/360.0
#define AXIS1_STEPS_PER_WORMROT    128000 //  12800, n. Number of steps per worm rotation (PEC Eq mode only:)                <-Req'd
...
#define AXIS2_STEPS_PER_DEGREE    12561 //Tom:13360 //  orig:12800, n. Number of steps per degree:                                          <-Req'd
                                          //         n = (stepper_steps * micro_steps * overall_gear_reduction)/360.0
...
#define AXIS4_LIMIT_MIN_RATE           10 //     50, n. Where n=1..1000 (um/s.) Minimum microns/second. In DC mode, min pwr.  Adjust
#define AXIS4_LIMIT_MIN                 0 //      0, n. Where n=0..500 (millimeters.) Minimum allowed position.               Adjust
#define AXIS4_LIMIT_MAX                26 //     50, n. Where n=0..500 (millimeters.) Maximum allowed position.               Adjust
...
// AUXILIARY ADDON FEATURE CONTROL ------------------------------ @DS -- ALSO UPDATE OnStep\addons\Ethernet\Config.h
